// Central place for company details. Update these once and the whole site follows.
export const site = {
  name: 'Urban Projects Cyprus',
  tagline: 'Trust · Build · Deliver',
  promise: 'Your Project, Our Promise.',
